...
const DesignConfigurator = ({ imageUrl, imageDimensions, configId }: DesignConfiguratorProps) => {
                    ...
                    {COLORS.map((color) => (
                      <Radio
                        ...
                        className={cn(
                          ...
                          {
                            [`border-${color.tw}`]: color.value === options.color.value,
                          }
                        )}
                      >
                        <span
                    ...
                    <div className="mt-3 space-y-4">
                      {selectableOptions.map((option) => (
                        <Radio
                          ...
                          value={option}
                          className={cn(
                            'relative block cursor-pointer rounded-lg bg-white px-6 py-4 shadow-sm border-2 border-zinc-200 focus:outline-none ring-0 focus:ring-0 outline-non sm:flex sm:justify-between',
                            { 'border-primary': option.value === options[name].value }
                          )}
                        >
                          ...
                          <Label className="mt-2 flex text-sm sm:ml-4 sm:mt-0 sm:flex-col sm:text-right">
        ...
        <div className="w-full px-8 h-16 bg-white">
          ...
          <div className="w-full h-full flex justify-end items-center">
            <div className="w-full flex gap-6 items-center">
              ...
              <Button onClick={saveConfiguration} size="sm" className="w-full font-bold">
                Continue
